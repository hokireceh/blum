...
class Blum:
    ...
    def log(self, msg):
        # Hapus kode warna ANSI dari pesan yang akan dikirim
        ...
        # Kirim pesan ke Telegram tanpa warna
...
{magenta}╰╯╰┻┻╯╱╱╱╱╰╯╰╯╰┳╯┣━┻━┻━╯
{magenta}╱╱╱╱╱╱╱╱╱╱╱╱╱╱╱╰━╯
	{white}Blum Auto Claim for {green}Blum
	{green}Group : {white}@airdrop_indonesia_update
	{white}Channel : {green}@GarapanAirdrop_Indonesia 
	{green}Note : {white}Hanya untuk pemakaian pribadi
{yellow}Note : {red}Jangan lupa ( git pull ) sebelum mulai
        """
